    ...
    return (
        <div className="container-fluid running-shoe mt-2" id='running-shoes'>
            ...
            <div className="shoes d-flex overflow-scroll">
                ...
                <div className="shoe ms-2 me-2">
                    <img src="./running-shoe-4.webp" alt="shoe" />
                    <p className="shoe-name m-0">Nike Structure 25</p>
                    <p className="for-shoe m-0">Women's Road Running Shoe</p>
                    <p className="MRP m-0"> MRP: 11 895</p>
                </div>
                <div className="shoe ms-2 me-2">
                    <img src="./running-shoe-5.webp" alt="shoe" />
                    <p className="shoe-name m-0">Nike Structure 25</p>
                    <p className="for-shoe m-0">Women's Road Running Shoe (wide)</p>
                    <p className="MRP m-0"> MRP: 16 995</p>
                </div>
                <div className="shoe ms-2 me-2">
                    <img src="./running-shoe-6.webp" alt="shoe" />
                ...
                <div className="shoe ms-2 me-2">
                    <img src="./running-shoe-7.jfif" alt="shoe" />
